...
files_edges <- list.files(path = "3_results_6d_cnae", pattern = "similarities", full.names = TRUE)
files_nodes <- list.files(path = "3_results_6d_cnae", pattern = "OS_nodelist", full.names = TRUE)
...
product_network <- complexity_graph(proximity_mat = proximidades, threshold = 0.4)
...
saveRDS(edgelist_product, "3_results_6d_cnae/edgelist_average_all_period.RDS")
fwrite(edgelist_product, "3_results_6d_cnae/edgelist_average_all_period.csv",
...
saveRDS(nodes_average, "3_results_6d_cnae/nodes_average_all_period.RDS")
fwrite(nodes_average, "3_results_6d_cnae/nodes_average_all_period.csv",
       scipen = getOption("scipen", 999L))
...
createNetworkFromIgraph(product_network, title = "Occupations Space 6d", collection = "Occupations Space")
