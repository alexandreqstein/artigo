...
files <- list.files(path = "1_dados", pattern = "emprego_municipio_cbo_20")
...
foreach( k = seq_along(files)) %dopar% {
    ...
    ggsave(str_c("3_results_6d/ECI_diversificacao_", anos[k], ".png"), plot = a,
    ...
    ggsave(str_c("3_results_6d/PCI_ubiquidade_", anos[k], ".png"), plot = a,
           height = 20, width = 20, units = "cm")
