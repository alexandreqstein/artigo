...
files_edges <- list.files(path = "3_results_6d", pattern = "similarities", full.names = TRUE)
files_nodes <- list.files(path = "3_results_6d", pattern = "OS_nodelist", full.names = TRUE)
...
saveRDS(edgelist_product, "3_results_6d/edgelist_average_all_period.RDS")
fwrite(edgelist_product, "3_results_6d/edgelist_average_all_period.csv",
...
saveRDS(nodes_average, "3_results_6d/nodes_average_all_period.RDS")
fwrite(nodes_average, "3_results_6d/nodes_average_all_period.csv",
       scipen = getOption("scipen", 999L))
...
nodes_average %>% 
    ...
    filter(interesse == "1") %>%
    write_excel_csv2(a, "ocupacoes_interesse_6d.csv")'
