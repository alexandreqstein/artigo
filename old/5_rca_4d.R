...
for (k in seq_along(1:(length(dados_completos)))){
  ...
  if (k < length(dados_completos)){
    
    lista_densidades[[k]] <- dados_completos[[k]][[1]][[1]]
    lista_empregos_total[[k]] <- dados_completos[[k]][[2]][[1]]
    lista_empregos_cbo_interesse[[k]] <- dados_completos[[k]][[3]][[1]]
    lista_rca[[k]] <- dados_completos[[k]][[4]][[1]]
    lista_rcanb[[k]] <- dados_completos[[k]][[5]][[1]]
    lista_rca_var[[k]] <- dados_completos[[k]][[6]][[1]]
    lista_qtd.rca.interesse[[k]] <- dados_completos[[k]][[7]][[1]]
      ...
      lista_densidades[[k+1]] <- dados_completos[[k]][[1]][[2]]
      lista_empregos_total[[k+1]] <- dados_completos[[k]][[2]][[2]]
      lista_empregos_cbo_interesse[[k+1]] <- dados_completos[[k]][[3]][[2]]
      lista_rca[[k+1]] <- dados_completos[[k]][[4]][[2]]
      lista_rcanb[[k+1]] <- dados_completos[[k]][[5]][[2]]
      #lista_rca_var[[k+1]] <- dados_completos[[k]][[6]][[2]]
      lista_qtd.rca.interesse[[k+1]] <- dados_completos[[k]][[7]][[2]]
